...
import_class("ViewBarchart.js", "TP")
	...
	var BarChart = function(){
		...
		__g__.mouseoverBarChartRect = function(event)
		{
          ...
          node.style("fill",function(d){if(!d.nbselect) d.nbselect = 0; d.nbselect++; return "red";});
                      //.enter()
		...
		__g__.mouseoutBarChartRect = function(event)
		{
		   ...
		   var tabClick = event.associatedData.tabClick;
            ...
            node.style("fill",function(d){d.nbselect--; if(d.nbselect == 0){return TP.Context().view[targetView].getNodesColor()} return "red";});
		}
		...
		__g__.mouseclickBarChartRect = function(event)
		{
            ...
            if(tabClick[""+value[2]] == 1){
	            ...
	            node.style("fill",function(d){d.nbselect--; if(d.nbselect == 1){return TP.Context().view[targetView].getNodesColor()} return "red";});
                 ...
                 if(tabClick[""+value[2]] == 0){
			          ...
			          node.style("fill",function(d){d.nbselect++; return "red";});	            
                }
            }
