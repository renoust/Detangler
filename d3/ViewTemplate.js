...
import_class('StateTree.js', 'TP')
	...
	var ViewTemplate = function(id, groupe, svgs, name, type, idAssociation, bouton){
	    ...
	    __g__.getController = function(){    	
	     ...
	     {    
		    ...
		    if(__g__.typeView ==="substrate")    {TP.Context().activeView = __g__.ID; dialogTop=16;  dialogRight=400; }
		    else if(__g__.typeView ==="catalyst"){ dialogTop=16;  dialogRight=100; }
		    else                        {dialogTop=235; dialogRight=260; }	     	
		    ...
		    __g__.titlebar.dblclick(function() {
		        if(__g__.typeView ==="substrate")    {dialogTop=26;  dialogRight=600; }
		        else if(__g__.typeView ==="catalyst"){ dialogTop=26;  dialogRight=100; }
		        else                        { dialogTop=240; dialogRight=260; }
	     	...
	     	if (__g__.typeView === "substrate"){__g__.titlebar.css('background', "url(css/smoothness/images/ui-bg_glass_95_fef1ec_1x400.png) 50% 50% repeat-x")}
    ...
    return {ViewTemplate : ViewTemplate};
})()