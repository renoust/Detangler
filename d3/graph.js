...
graph = function() 
{
    ...
    this.links = function(x, type) {
        ...
        x.forEach(function(d)
        {
            ...
            if(typeof o.source != "number" && typeof o.source != "string") //object already bounded
                o.source = o.source.baseID;
            if(typeof o.target != "number" && typeof o.target != "string") //object already bounded
    ...
    this.edgeBinding = function() 
    {
       ...
       for (var i = 0; i < n; ++i) {
           ...
           if(!(node._type in o))
            {
                o[node._type] = {};
                //console.log("adding the type: ",n._type, " to ",o);
            }
    ...
    //console.log("nodeToBaseId : ",o)
       ...
       for (i = 0; i < m; ++i) {
        ...
        {
            //console.log("associating: ",l.source," with ",o[l._type])
