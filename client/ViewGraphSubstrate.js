    ...
    var ViewGraphSubstrate = function (parameters) {
        ...
        */
        ...
        __g__.initStates = function () {
            ...
            __g__.controller.addEventState("zoneApparu", ["toto","nodeSelected", "selectionVide", "arrangeLabels"], function (_event) {
            ...
            __g__.controller.addEventState("analyseGraph", ["all"], function (_event) {/*assert(true, "analyseGraph");*/
                TP.Client().analyseGraph(_event);
            }, true, null, true);
            __g__.controller.addEventState("answerAnalyseGraph", ["all"], function (_event) {/*assert(true, "answerAnalyseGraph");*/
