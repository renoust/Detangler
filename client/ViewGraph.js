    ...
    var ViewGraph = function (parameters) {
        ...
        __g__.remove = function () {
         ...
         __g__.initStates = function () {
            ...
            __g__.controller.addState({name: "arrangeLabels", bindings: ["movingZoomDrag", "mouseoverMouseDown", "mousemoveLasso", "mousemoveMouseDown", "mousedownMouseDown", "mouseupMouseDown", "sizeMapping"], func: function (_event) {/*assert(true, "arrangeLabels"); */
